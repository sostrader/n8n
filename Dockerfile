...
RUN npm install langfuse@3.18.0 langfuse-langchain@3.18.0 duck-duck-scrape odoo-await @mozilla/readability arxiv-api google-trends-api-code archive-search semanticscholarjs n8n-nodes-pdf-to-imgs n8n-nodes-pdfkit
